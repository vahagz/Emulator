...
BEGIN_MESSAGE_MAP(CEmulatorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CEmulatorApp::OnAppAbout)
...
CEmulatorApp::CEmulatorApp() noexcept
{
	...
	SetAppID(_T("Emulator.AppID.NoVersion"));
